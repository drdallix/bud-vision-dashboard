...
const StrainVisualCard = ({ strain }: StrainVisualCardProps) => {
  ...
  const getSecondaryColor = (type: string) => {
    switch (type) {
      case 'Indica': return 'bg-purple-100 border-purple-200';
      case 'Sativa': return 'bg-green-100 border-green-200';
      case 'Hybrid': return 'bg-blue-100 border-blue-200';
