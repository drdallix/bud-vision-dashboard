...
const ToneShowcase = ({ strain, onDescriptionChange }: ToneShowcaseProps) => {
    ...
    <Card className="border-purple-200 bg-gradient-to-br from-purple-50/50 to-pink-50/50">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <div className="p-3 bg-white border rounded-lg text-sm min-h-[100px] max-h-[200px] overflow-y-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-2">
          ...
          <Button
            onClick={applyDescriptionToDatabase}
